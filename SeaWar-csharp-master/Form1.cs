...
namespace SeaWars
{
    public partial class Form1 : Form
    {
        ...
        public void CreateMaps()
        {
            ...
            Button connectClientButton = new Button();
            connectClientButton.Text = "Подключить второго игрока";
            connectClientButton.Click += new EventHandler(ConnectClient);
            connectClientButton.Location = new Point(100, mapSize * cellSize + 20);
            this.Controls.Add(connectClientButton);
        }
        ...
        public void ConnectClient(object sender, EventArgs e)
        {
            Client client = new Client("hello shiny)");
